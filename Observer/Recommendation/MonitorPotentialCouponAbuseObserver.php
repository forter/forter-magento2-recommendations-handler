...
/**
 * MONITOR_POTENTIAL_COUPON_ABUSE Observer
 */
class MonitorPotentialCouponAbuseObserver implements ObserverInterface
{
    /**
     * Handle a MONITOR_POTENTIAL_COUPON_ABUSE recommendation.
    ...
    public function execute(Observer $observer)
    {
        try {
             ...
             * @var string
             */
            $recommendation = $event->getRecommendation(); // MONITOR_POTENTIAL_COUPON_ABUSE
